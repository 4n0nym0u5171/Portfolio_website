...
const WORKS_PROJECTS = [
  ...
  { 
    ...
    features: ['Role based access control', 'Appointment Scheduling', 'Email Notifications','Single Page Application'], 
    screenshots: [
      'src/img/MDLAW1.jpg',
      'src/img/MDLAW2.jpg',
      'src/img/MDLAW3.jpg',
    ...
    links: { github: 'https://github.com/4n0nym0u5171/MDLaw', docs: '#' } 
  },
  { 
    id: 3, 
